...
- **Все 5 магазинов** доступны на всех тарифах
- **Умный поиск + уведомления + экспорт + 24/7** — эксклюзив продвинутого тарифа
- **Скидка 20%** на первый платёж любого платного тарифа
- Подробная спецификация: `docs/subscriptions.md`
