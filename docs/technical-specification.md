...
- Обновление цен: каждые 6 часов для базового тарифа, real-time для продвинутого
...
| Функция | Пробный | Базовый (399 ₽/мес) | Продвинутый (499 ₽/мес) |
|---------|---------|---------|------------|
| Количество товаров | до 10 | до 100 | безлимит |
| Количество поставщиков | 2 | 15+ | 50+ |
| Обновление цен | 24ч | 6ч | real-time |
| История цен | 1 месяц | 6 месяцев | 12+ месяцев |
| Экспорт отчётов | — | PDF/CSV | PDF/CSV |
| Нечёткий поиск | — | — | ✓ |
| API-доступ | — | — | ✓ |
| Расширенная аналитика | — | — | ✓ |
| Поддержка | — | 24/7 | 24/7 + менеджер |
...
2. POST `/api/auth/register` — создаётся пользователь + подписка trial на 10 дней
...
- [ ] Расширенная аналитика для продвинутого тарифа
- [ ] API-доступ
