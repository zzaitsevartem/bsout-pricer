...
DEVICES: list[tuple[str, str, str, list[str]]] = [
    ...
    ("HTC", "HTC Desire", "htc-desire", ["htc desire", "хтс desire"]),
    ("HTC", "HTC Desire 300", "htc-desire-300", ["htc desire 300", "desire 300"]),
    ("HTC", "HTC Desire 310", "htc-desire-310", ["htc desire 310", "desire 310"]),
    ("HTC", "HTC 8S", "htc-8s", ["htc 8s", "хтс 8s"]),
    ("HTC", "HTC 8X", "htc-8x", ["htc 8x", "хтс 8x"]),
    ("HTC", "HTC 10", "htc-10", ["htc 10", "хтс 10"]),
    ("Vivo", "Vivo V11", "vivo-v11", ["vivo v11", "виво v11"]),
    ("Vivo", "Vivo V15 Pro", "vivo-v15-pro", ["vivo v15 pro", "виво v15 pro"]),
    ("Vivo", "Vivo T1", "vivo-t1", ["vivo t1", "виво t1"]),
    ("ZTE", "ZTE Blade 20 Smart", "zte-blade-20-smart", ["zte blade 20 smart", "blade 20 smart"]),
    ("ZTE", "ZTE Blade A3", "zte-blade-a3", ["zte blade a3", "blade a3"]),
    ("Meizu", "Meizu M3 Max", "meizu-m3-max", ["meizu m3 max", "мейзу m3 max"]),
    ("Meizu", "Meizu E3", "meizu-e3", ["meizu e3", "мейзу e3"]),
    ("Alcatel", "Alcatel U5 (4047D)", "alcatel-u5-4047d", ["alcatel 4047d", "4047d", "alcatel u5"]),
    ("Alcatel", "Alcatel 3C (5026D)", "alcatel-3c-5026d", ["alcatel 5026d", "5026d", "alcatel 3c"]),
    ("Alcatel", "Alcatel 1016D", "alcatel-1016d", ["alcatel ot-1016d", "ot-1016d", "1016d"]),
    ("Lenovo", "Lenovo A1000", "lenovo-a1000", ["lenovo a1000", "леново a1000"]),
    ("Lenovo", "Lenovo A2010", "lenovo-a2010", ["lenovo a2010", "леново a2010"]),
    ("Lenovo", "Lenovo A3000", "lenovo-a3000", ["lenovo a3000", "леново a3000"]),
    ("Lenovo", "Lenovo A5000", "lenovo-a5000", ["lenovo a5000", "леново a5000"]),
    ("Samsung", "Galaxy Tab A7 Lite (SM-T220)", "samsung-sm-t220", ["sm-t220", "t220"]),
    ("Samsung", "Galaxy Tab A7 Lite (SM-T225)", "samsung-sm-t225", ["sm-t225", "t225"]),
    ("Samsung", "Galaxy Tab A 7.0 (SM-T285)", "samsung-sm-t285", ["sm-t285", "t285"]),
    ("Samsung", "Galaxy Tab 3 (SM-T210)", "samsung-sm-t210", ["sm-t210", "t210"]),
    ("Samsung", "Galaxy Tab 4 7.0 (SM-T230)", "samsung-sm-t230", ["sm-t230", "t230"]),
    ("Samsung", "Galaxy Tab 3 Lite (SM-T110)", "samsung-sm-t110", ["sm-t110", "t110"]),
    ("Samsung", "Galaxy S (i9000)", "samsung-i9000", ["i9000", "samsung i9000"]),
    ("Samsung", "Galaxy S3 mini (i8190)", "samsung-i8190", ["i8190", "galaxy s3 mini"]),
    ("Apple", "iPad 7", "apple-ipad-7", ["ipad 7", "айпад 7"]),
    ("Apple", "iPad Air 2", "apple-ipad-air-2", ["ipad air 2", "айпад air 2"]),
    ("Apple", "iPad Pro 12.9", "apple-ipad-pro-12-9", ["ipad pro 12.9", "ipad pro 12,9"]),
